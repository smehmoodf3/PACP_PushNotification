...
namespace RegisterDevice.PacpDataService {
    ...
    public partial class ClsAlerts : RegisterDevice.PacpDataService.ClsMaster {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(RegisterDevice.PacpDataService.ClsAbout))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(RegisterDevice.PacpDataService.Device))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(RegisterDevice.PacpDataService.ClsAlerts))]
    ...
    [System.SerializableAttribute()]
    public partial class ClsAbout : RegisterDevice.PacpDataService.ClsMaster {
    ...
    [System.SerializableAttribute()]
    public partial class Device : RegisterDevice.PacpDataService.ClsMaster {
    ...
    public interface IPacp {
        ...
        RegisterDevice.PacpDataService.ClsAlerts[] GetAllAlerts();
        ...
        RegisterDevice.PacpDataService.ClsAlerts GetAlertById(System.Nullable<int> Id);
        ...
        string InsertAlert(RegisterDevice.PacpDataService.ClsAlerts obj);
        ...
        string GetInsertAlertResponse(RegisterDevice.PacpDataService.ClsAlerts obj);
        ...
        string UpdateAlert(RegisterDevice.PacpDataService.ClsAlerts obj);
        ...
        string GetUpdateAlertResponse(RegisterDevice.PacpDataService.ClsAlerts obj);
        ...
        RegisterDevice.PacpDataService.ClsAbout[] GetAllAbout();
        ...
        RegisterDevice.PacpDataService.ClsAbout GetAboutById(System.Nullable<int> Id);
        ...
        string InsertAbout(RegisterDevice.PacpDataService.ClsAbout obj);
        ...
        string UpdateAbout(RegisterDevice.PacpDataService.ClsAbout obj);
        ...
        RegisterDevice.PacpDataService.clsUser[] GetAllUsers();
        ...
        RegisterDevice.PacpDataService.clsUser GetUserById(System.Nullable<int> Id);
        ...
        RegisterDevice.PacpDataService.clsUser GetUserByNamePwd(string UserName, string Password, string UserType);
        ...
        string InsertUser(RegisterDevice.PacpDataService.clsUser obj);
        ...
        string UpdateUser(RegisterDevice.PacpDataService.clsUser obj);
        ...
        RegisterDevice.PacpDataService.ClsAlerts[] getAlerts(string title, string desc);
        ...
        RegisterDevice.PacpDataService.Device[] GetAllDevices();
        ...
        RegisterDevice.PacpDataService.Device[] GetDevicesByType(int deviceType);
        ...
        RegisterDevice.PacpDataService.Device GetDevice(string deviceRegistrationId);
        ...
        string insertDevice(RegisterDevice.PacpDataService.Device device);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPacpChannel : RegisterDevice.PacpDataService.IPacp, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PacpClient : System.ServiceModel.ClientBase<RegisterDevice.PacpDataService.IPacp>, RegisterDevice.PacpDataService.IPacp {
        ...
        public RegisterDevice.PacpDataService.ClsAlerts[] GetAllAlerts() {
            return base.Channel.GetAllAlerts();
        }
        
        public RegisterDevice.PacpDataService.ClsAlerts GetAlertById(System.Nullable<int> Id) {
            return base.Channel.GetAlertById(Id);
        }
        
        public string InsertAlert(RegisterDevice.PacpDataService.ClsAlerts obj) {
            return base.Channel.InsertAlert(obj);
        }
        
        public string GetInsertAlertResponse(RegisterDevice.PacpDataService.ClsAlerts obj) {
            return base.Channel.GetInsertAlertResponse(obj);
        }
        
        public string UpdateAlert(RegisterDevice.PacpDataService.ClsAlerts obj) {
            return base.Channel.UpdateAlert(obj);
        }
        
        public string GetUpdateAlertResponse(RegisterDevice.PacpDataService.ClsAlerts obj) {
        ...
        public RegisterDevice.PacpDataService.ClsAbout[] GetAllAbout() {
            return base.Channel.GetAllAbout();
        }
        
        public RegisterDevice.PacpDataService.ClsAbout GetAboutById(System.Nullable<int> Id) {
            return base.Channel.GetAboutById(Id);
        }
        
        public string InsertAbout(RegisterDevice.PacpDataService.ClsAbout obj) {
            return base.Channel.InsertAbout(obj);
        }
        
        public string UpdateAbout(RegisterDevice.PacpDataService.ClsAbout obj) {
        ...
        public RegisterDevice.PacpDataService.clsUser[] GetAllUsers() {
            return base.Channel.GetAllUsers();
        }
        
        public RegisterDevice.PacpDataService.clsUser GetUserById(System.Nullable<int> Id) {
            return base.Channel.GetUserById(Id);
        }
        
        public RegisterDevice.PacpDataService.clsUser GetUserByNamePwd(string UserName, string Password, string UserType) {
            return base.Channel.GetUserByNamePwd(UserName, Password, UserType);
        }
        
        public string InsertUser(RegisterDevice.PacpDataService.clsUser obj) {
            return base.Channel.InsertUser(obj);
        }
        
        public string UpdateUser(RegisterDevice.PacpDataService.clsUser obj) {
        ...
        public RegisterDevice.PacpDataService.ClsAlerts[] getAlerts(string title, string desc) {
            return base.Channel.getAlerts(title, desc);
        }
        
        public RegisterDevice.PacpDataService.Device[] GetAllDevices() {
            return base.Channel.GetAllDevices();
        }
        
        public RegisterDevice.PacpDataService.Device[] GetDevicesByType(int deviceType) {
            return base.Channel.GetDevicesByType(deviceType);
        }
        
        public RegisterDevice.PacpDataService.Device GetDevice(string deviceRegistrationId) {
            return base.Channel.GetDevice(deviceRegistrationId);
        }
        
        public string insertDevice(RegisterDevice.PacpDataService.Device device) {
